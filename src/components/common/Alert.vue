<template>
  <div class="alert">
    <div class="flex flex-col md:items-center md:flex-row">
      <div
        class="mr-3 p-4 rounded rounded-tr-none rounded-br-none text-white hidden md:block"
        :class="type"
      >
        <fa
          size="lg"
    ...
    <div class="flex xl:items-center lg:items-center sm:justify-end justify-center pr-4">
      <router-link
        :to="link"
        class="focus:outline-none focus:text-indigo-400 hover:text-indigo-400 text-sm mr-4 font-bold cursor-pointer text-indigo-700 dark:text-indigo-600"
      >
        Details
      </router-link>
      <button
